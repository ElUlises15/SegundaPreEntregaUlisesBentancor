...
const ItemCount = () => {
  ...
  const mostrarMensaje = () => {
    contador != 0
      ? alert(`${contador} producto/s agregado/s al carrito de compras`)
      : alert(`Tienes ${contador} producto/s en tu lista`);
  };
  ...
  return (
    <div style={{ backgroundColor: "#4A235A", padding: 25 }}>
      {contador > 0 ? (
        <Button colorScheme="red" size="sm" onClick={resta}>
          Quitar
        </Button>
      ) : (
        <Button disabled>Quitar</Button>
      )}
